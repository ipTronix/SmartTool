...
extern void SSP_Send( uint8_t portNum, uint8_t *Buf, uint32_t Length, uint8_t lsb_first);
extern void SSP_Send_naked( uint8_t portNum, uint8_t *Buf, uint32_t Length, uint8_t lsb_first);
extern void SSP_Receive( uint8_t portNum, uint8_t *buf, uint32_t Length, uint8_t lsb_first );
extern void SSP_Send_Receive(uint8_t portNum, const uint8_t *pbtTx, const size_t szTx, uint8_t *pbtRx, const size_t szRx, uint8_t lsb_first);
extern void SSP_Receive_naked( uint8_t portNum, uint8_t *buf, uint32_t Length, uint8_t lsb_first );
extern void SSP_SetCS(uint8_t portNum, uint8_t state);
