...
//    timer32_1_period = period;
    LPC_CT32B1->MR3 = period;
    LPC_CT32B1->MR0 = period/2;
    LPC_CT32B1->MR1 = period/2;
    LPC_CT32B1->MR2 = period/2;
...
//    timer32_0_period = period;
    ...
    LPC_CT32B0->MR0 = period/2;
    LPC_CT32B0->MR1 = period/2;
    LPC_CT32B0->MR2 = period/2;
