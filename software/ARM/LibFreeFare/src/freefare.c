 ...
 *
 * $Id: freefare.c 974 2012-01-25 09:58:16Z adiacre@il4p.fr $
 */
...
const struct supported_tag supported_tags[] = {
...
{
    char *res = pvPortMalloc (2 * tag->info.szUidLen + 1);
